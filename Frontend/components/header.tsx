      ...
      <div className="flex items-center justify-between px-6 py-3">
        ...
        <div className="flex-1 max-w-md">
          <div className="relative">
            ...
            />
            <div className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-muted-foreground bg-white px-1.5 py-0.5 rounded border">
              Ctrl K
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Language */}
          <Button variant="ghost" size="sm" className="gap-2 hover:bg-muted rounded-xl text-muted-foreground">
